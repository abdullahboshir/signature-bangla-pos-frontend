    ...
    return (
        <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
            <div className="flex items-center space-x-2 mb-6">
                ...
                <div>
                    <h2 className="text-3xl font-bold tracking-tight">Add Measurement Unit</h2>
                    <p className="text-muted-foreground">Define a measurement unit for your products.</p>
                </div>
            </div>
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        ...
                                        <Input id="name" {...register("name", { required: true })} placeholder="e.g. Kilogram" />
                                        {errors.name && <span className="text-sm text-red-500">Name is required</span>}
                                    </div>

                                    <div className="space-y-2">
                                        <Label htmlFor="symbol">Symbol <span className="text-red-500">*</span></Label>
                                        <Input id="symbol" {...register("symbol", { required: true })} placeholder="e.g. kg" />
