...
import { SubscriptionDialog } from "@/app/(protected)/platform/companies/SubscriptionDialog";
...
export default function SubscriptionPage() {
    ...
    const companyIdParam = searchParams.get("organization");
    const { user } = useAuth();
