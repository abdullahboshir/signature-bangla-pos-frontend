    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const payload = {
                ...
                roles: permissionsPayload.map(r => r.role),
                businessUnits: permissionsPayload.map(r => r.businessUnit).filter(Boolean),

                status: "active"
            };

            console.log("Submitting user (Global Flow):", payload);
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Create a new user account and assign roles/permissions across any business unit.
                    </p>
                </div>
            </div>
