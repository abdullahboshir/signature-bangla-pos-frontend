...
export function SubscriptionDialog({ company, open, onOpenChange }: SubscriptionDialogProps) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const clientId = company.id || (company as any)._id || (company as any).value;
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Update plan and billing status for <span className="font-semibold text-foreground">{company.name}</span>.
                    </DialogDescription>
                </DialogHeader>
