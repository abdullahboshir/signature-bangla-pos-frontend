...
export default function AddCompanyPage() {
    ...
    const validateStep = () => {
        if (currentStep === 1) {
            if (!formData.branding.name) return "Company Name is required"
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        id="description"
                                        placeholder="Brief overview of the company's activities..."
        ...
        <div className="container max-w-5xl mx-auto py-8 space-y-8">
            <div>
                ...
                <p className="text-muted-foreground mt-2">
                    Set up a new company in your organization structure
                </p>
            </div>
